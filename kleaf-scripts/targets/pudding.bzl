...
load(":configs/pudding_perf.bzl", "pudding_perf_config")
load(":configs/pudding_consolidate.bzl", "pudding_consolidate_config")
...
def define_pudding():
    ...
    define_typical_android_build(
        name = target_name, 
        arch = target_arch,
        consolidate_config = canoe_perf_config | canoe_consolidate_config | pudding_perf_config | pudding_consolidate_config,
        perf_config = canoe_perf_config | pudding_perf_config,
