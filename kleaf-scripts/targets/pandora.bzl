...
load(":configs/pandora_perf.bzl", "pandora_perf_config")
load(":configs/pandora_consolidate.bzl", "pandora_consolidate_config")
...
def define_pandora():
    ...
    define_typical_android_build(
        name = target_name, 
        arch = target_arch,
        consolidate_config = canoe_perf_config | canoe_consolidate_config | pandora_perf_config | pandora_consolidate_config,
        perf_config = canoe_perf_config | pandora_perf_config,
